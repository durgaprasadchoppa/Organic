...
// const MyOrders = () => {
//     const [myOrders, setMyOrders] = useState([]) // Ensure it's an empty array
...
//                                 <div key={item.product._id} className={`relative bg-white text-gray-500/70 ${order.items.length !== item.index + 1 && "border-b"} border-gray-300 flex flex-col md:flex-row md:items-center justify-between p-4 py-5 md:gap-16 w-full max-w-4xl`}>
//                                     <div className="flex items-center mb-4 md:mb-0">
//                                         <div className="bg-primary/10 p-4 rounded-lg">
...
//             const { data } = await axios.get('/api/order/user')
//             if (data.success) {
//                 setMyOrders(data.orders || [])  // Ensure data.orders is an array
//             }
//         } catch (error) {
//             console.log(error)
//         }
